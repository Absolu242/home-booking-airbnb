...
export default function Room() {
  ...
  const room = data.data.filter((el) => el.id === parseInt(roomId))[0];
                  ...
                  <div className="roomInfo-card">
                    ...
                    <div className="card-main">
                      <div className="wrapper">
                        ...
                        elit. Odit ipsam tempore asperiores voluptatibus commodi
                        voluptatum.
                      </div>
                    </div>
                  ...
                  <div className="roomInfo-card">
                    ...
                    <div className="card-main">
                      <div className="wrapper">
                        ...
                        adipisicing elit. Quo numquam voluptatibus autem eum
                        iure iste dolores vitae error necessitatibus! Provident
                        ad architecto error. Natus reprehenderit cum
                        voluptatibus aliquam, id nostrum!
                      </div>
                    </div>
                      ...
                      <div className="reviews-list">
                        <div className="review-item">
                          ...
                          <div className="review-main">
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Perspiciatis cum sit dignissimos, quas aliquam
                            ut tempora, laborum illum earum saepe ipsa similique
                            id! Fugiat consequatur, quibusdam cumque qui impedit
                            delectus!
                          </div>
                        </div>
                      </div>
